...
class FeatureExtractor(BaseFeaturesExtractor):
    ...
    def n_output_channels(self) -> int:
        ...
        with th.no_grad():
            return self.cnn(th.as_tensor(self._observation_space.sample()[None]).float()).shape[1]
    ...
    def __init__(self, observation_space: spaces.Box, features_dim: int = 512):
        ...
        self.linear = nn.Sequential(nn.Linear(self.n_output_channels, features_dim), nn.ReLU())

    def forward(self, observations: th.Tensor) -> th.Tensor:
        return self.linear(self.cnn(observations))


class Algorithm(OffPolicyAlgorithm):
    """
    Deep Q-Network (DQN)
    ...
    def _setup_model(self) -> None:
        super(Algorithm, self)._setup_model()
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(Algorithm, self)._excluded_save_params() + ["q_net", "q_net_target"]
